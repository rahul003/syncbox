...
DATABASES = {
    'default': {
        ...
        'NAME': '../blob.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'e_e6ck9+e0qmpn91x^at80@$*#3bk$o1!g#^b0_&p3cixjc=70'
...
INSTALLED_APPS = (
    ...
    'fileupload',
    'organizations',
    'search',               #This app(search) is done for implementing groups sorry for the name  
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'arpitdemo27@gmail.com'
EMAIL_HOST_PASSWORD = 'project27arpit'
...
#settings for bootstrap_toolkit
